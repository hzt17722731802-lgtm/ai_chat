...
public class IntentRecognitionService {
    ...
    private String buildPrompt(String userInput) {
        return String.format(
            "你是一个医疗对话助手。请从患者的问题中识别意图（使用中文输出），并抽取出所有医疗相关实体（疾病、症状、检查、药品、治疗、科室），以JSON格式返回。 /no_think\n" +
            "**输出要求：**\n\n" +
            ...
            "- 实体类型有：疾病、症状、检查、药品、治疗、科室。\n" +
            "- 如果用户没有提到任何实体，entities 为空数组。\n\n" +
            "**示例：**\n\n" +
            "患者问题：我最近咳嗽、发烧，喉咙痛，应该是感冒了。\n" +
            "{\"intent\": \"描述症状\", \"entities\": [{\"type\": \"症状\", \"value\": \"咳嗽\"}, {\"type\": \"症状\", \"value\": \"发烧\"}, {\"type\": \"症状\", \"value\": \"喉咙痛\"}, {\"type\": \"疾病\", \"value\": \"感冒\"}]}\n\n" +
            "患者问题：糖尿病要做什么检查\n" +
            "{\"intent\": \"询问所需检查\", \"entities\": [{\"type\": \"疾病\", \"value\": \"糖尿病\"}]}\n\n" +
            "患者问题：肺炎应该吃什么药？\n" +
